...
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{fig_2d_8k.png}
\includegraphics[scale=0.3]{fig_3d_8k.png}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{Mplot.png}
  \captionof{figure}{Plotting part of the matrix M}
  \label{fig:test1}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{signularvalues.png}
  \captionof{figure}{Singular values of M}
  \label{fig:test2}
\end{minipage}
\end{figure}
\vspace{10pt}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.5\linewidth]{fig_2d_1k.png}
  \captionof{figure}{Using only 1 nearest neighbor}
  \label{fig:test1}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.5\linewidth]{fig_2d_3k.png}
  \captionof{figure}{Using 3 nearest neighbor}
  \label{fig:test2}
\end{minipage}
\end{figure}
\problemAnswer{
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.5\linewidth]{fig_2d_7k.png}
  \captionof{figure}{K=7, Euclidean distance}
  \label{fig:test1}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.5\linewidth]{fig_2d_7k_hamming.png}
  \captionof{figure}{K=7, Hamming distance}
  \label{fig:test2}
\end{minipage}%
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=.5\linewidth]{fig_2d_7k_cheby.png}
...
See figure 9 where a data point is reconstructed using this method. The figures also show the original image for comparison.
