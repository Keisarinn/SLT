...
\problemAnswer{ % Answer
        ...
        In the plots, expecially the 3D ones, the clusters are clearly visible. It seems that more numbers are "recognised" (gathered in the same cluster) better tant the others.
            ...
            \includegraphics[scale=0.10]{imgs/2D_2000.png}
            \includegraphics[scale=0.10]{imgs/3D_1_2000.png}
            \includegraphics[scale=0.10]{imgs/3D_2_2000.png}
            \includegraphics[scale=0.10]{imgs/3D_3_2000.png}

            % \animategraphics{12}{Python/interp/im_}{0}{19}[scale=3]
            ...
            \includegraphics[scale=0.25]{imgs/mat_20_1.png}
            \includegraphics[scale=0.25]{imgs/mat_20_2.png}

            \animategraphics[loop,scale=3]{12}{Python/interp/im_}{0}{19}
        ...
        \subsubsection{Singular Values}
            ...
            \includegraphics[scale=0.12]{imgs/svd_1.png}
            \includegraphics[scale=0.12]{imgs/svd_2.png}



        \subsubsection{Interpolation in the embedding space}

        \animategraphics[loop,scale=3]{12}{Python/interp/im_}{0}{19}
        \subsubsection{interpolation in the original space}
