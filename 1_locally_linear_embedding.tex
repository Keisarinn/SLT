...
Fig. \ref{k10_embeddings} shows the calculated embeddings into 2-dimensional and 3-dimensional spaces using k=10 neighbors for each data point. Clearly a clustured structure can be observed, however not all of them are well separable.
