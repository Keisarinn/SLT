...
\begin{homeworkSection}{(b) Locally linear embedding}
\begin{center}
	\includegraphics[scale=0.6]{2Dembed_5neigh_Euclidean}
\end{center}
\begin{center}
	\includegraphics[scale=0.6]{3Dembed}
\end{center}
...
\problemAnswer{ % Answer
\begin{center}
	\includegraphics[scale=0.6]{matrix_plot}
\end{center}

}
\problemAnswer{ % Answer
	\begin{center}
		\includegraphics[scale=0.6]{2Dembed_3neigh_Euclidean}
	\end{center}
		\begin{center}
			\includegraphics[scale=0.6]{2Dembed_10neigh_Euclidean}
		\end{center}
...
\problemAnswer{ % Answer
	\begin{center}
		\includegraphics[scale=0.6]{2Dembed_5neigh_Manhattan}
	\end{center}
	\begin{center}
		\includegraphics[scale=0.6]{linear_int}
	\end{center}
