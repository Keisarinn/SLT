function [y, m] = lle(x, d, num_nn)
%% [y, m] = lle(x, d, num_nn)
% Apply the lle algorithm to the data in x.
%
%   Input:
...
function [nn_vecs, nn_ix] = lle_nn_1(p, x, num_nn)
